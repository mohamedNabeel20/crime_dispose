            ...
            children: [
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: "First name",hintStyle: TextStyle(color: Colors.black),
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: "Last name",hintStyle: TextStyle(color: Colors.black),
                    filled: true,
                    fillColor: Colors.white,
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(15),
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: "E-mail id",hintStyle: TextStyle(color: Colors.black),
                    filled: true,
                    fillColor: Colors.white,
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(15),
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    hintText: "Create password",hintStyle: TextStyle(color: Colors.black),
                    filled: true,
                    fillColor: Colors.white,
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(15),
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  backgroundColor: Color(0xff881736), // Text color
                ),
