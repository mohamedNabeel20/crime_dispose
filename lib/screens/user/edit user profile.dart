  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(color: Colors.white, onPressed: () {   Navigator.of(context).push(MaterialPageRoute(builder: (context) => ViewStudentProfile(),));}, icon: Icon(Icons.arrow_back),),
      ),
      backgroundColor: Colors.black,
      body: Padding(
