  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(color: Colors.white, onPressed: () {   Navigator.of(context).push(MaterialPageRoute(builder: (context) =>UserHome(),));}, icon: Icon(Icons.arrow_back),),
            ...
            children: [
              DropdownButtonFormField<String>(
                ...
                decoration: const InputDecoration(
                  label: Text("Select Crime Type",style: TextStyle(color: Colors.white),),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  label: Text("Crime Title",style: TextStyle(color: Colors.white),),
              ...
              Row(
                children: [
                  Expanded(
                    child: Text(
                      "Selected Date and Time: ${DateFormat.yMd().add_jm().format(selectedDate)}",style: TextStyle(color: Colors.white),
                    ),
                  ),
                ],
              ),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  label: Text("Crime Location",style: TextStyle(color: Colors.white),),
                  border: OutlineInputBorder(borderSide: BorderSide(color: Colors.red)
                  ),
                  focusedBorder: OutlineInputBorder(
                    borderSide: BorderSide(color: Colors.red)
                    ...
                    child: InkWell(
                      ...
                      child: const Row(
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text("Select Current Location",style: TextStyle(color: Colors.white),),
                        ],
                      ),
                    ),
                  ),
                  ...
                  ElevatedButton(
                    ...
                    child: const Row(
                      children: [
                        ...
                        SizedBox(width: 8.0),
                        Text('Select Location',style: TextStyle(color: Colors.redAccent),),
                      ],
                    ),
                  ),
                ],
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  label: Text("Complaint",style: TextStyle(color: Colors.white),),
                  border: OutlineInputBorder(
                    borderSide: BorderSide(color: Colors.red)
                  ),
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(
                          ...
                          onSurface: Color(0xff281537)),
                    ),
                  ),
                  const SizedBox(width: 16),
                  Text(
                      "Image: ${image != null ? image!.path.split('/').last : 'None'}", style: TextStyle(color: Colors.white),),
                ],
              ),
